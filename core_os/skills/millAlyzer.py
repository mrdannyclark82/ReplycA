...
def millAlyze_video(url: str):
    ...
    try:
        ...
        try:
            ...
            memory.remember(f"youtube_{video_id}", json.dumps(analysis))
            print(f"[*] millAlyzer: Insights locked into long-term memory.")
        except Exception as mem_err:
            print(f"[!] millAlyzer Memory Error: {mem_err}")
